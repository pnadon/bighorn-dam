...
var paragraphTexts = {
  ...
  "bighorn-dam":
    ...
    '<li>Hunting area</li>'
    +
    '<li>Grazing land for horses</li>'
    +
    '<li>Traplines</li>'
    +
    '<li>Sun Dance and Recreation Area</li>'
    +
    '<li>Historical / Cultural significance of the land</li>'
    +
    '<li>Disruption of way of life</li>'
    +
    '<li>Fear of living below the dam</li>'
    +
    '</ul>'
    +
    '<p>Unfortunately, the government &quot;turned a deaf ear&quot;, and the dam was built anyways.</p>',
  "new-kootenay-plains": '', "new-windy-point": '',
  "credits":
    '<p>Project designed and developed by Philippe Nadon, with the cards being a modified version of <a href="https://codepen.io/rachsmith/fullpage/PWxoLN">https://s.codepen.io/rachsmith/fullpage/PWxoLN</a>.</p>'
    +
    '<h2>Bibliography:</h2>'+
    '<p>Derek Chambers Photography <a href="https://derekchambersphotography.com/travels/around-bc-and-the-yukon/kootenay-plains-and-abraham-lakealberta/">https://derekchambersphotography.com/travels/around-bc-and-the-yukon/kootenay-plains-and-abraham-lakealberta/</a></p>'
    +
    '<p>Ross, Jane, and Daniel Kyba. <em>The David Thompson Highway: A Hiking Guide</em>. Calgary [Alta.]: Rocky Mountain Books, 1995.</p>'
    +
    '<p>Snow, John. <em>These Mountains Are Our Sacred Places: The Story of the Stoney Indians</em>. Toronto, ON: S. Stevens, 1977. </p>'
    +
    '<p>Pettapiece, <em>W. W.. LAND CLASSIFICATION AND SOILS IN THE ROCKY MOUNTAINS OF ALBERTA ALONG THE NORTH SASKATCHEWAN RIVER VALLEY</em>. Alberta Institute of Pedology, 1971.</p>'
    +
    '<p>Google Maps. <em>“Abraham Lake”</em>. Accessed Jan 16, 2019.<a href="%20https://goo.gl/maps/jwsMKN8d5bA2"> https://goo.gl/maps/jwsMKN8d5bA2</a></p>'
};
