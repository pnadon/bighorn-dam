...
function animateCoverUp(card) {
  ...
  openContentText.innerHTML =
    '<p style="text-align: center"><em>' + paragraphTexts[card.id][0] + '</em></p>' + '<h1>' + card.children[2].textContent + '</h1>' + paragraphTexts[card.id][1];
...
var paragraphTexts = {
  "kootenay-plains": [
    'A picture of the Kootenay Plains, 1971',
  ...
  "abraham-flats": [
    'In the far left corner, are the Abraham Flats, taken in 1971',
  ...
  "windy-point": [
    'A picture taken at Windy Point before Abraham Lake',
  ...
  "abraham-lake": [
    'The frozen methane bubbles are beautiful, but hint at a controversial past',
